...
declare module '#imports' {
  ...
  export { ColumnItem } from '../src/components/ColumnItem';
  export { ColumnManager } from '../src/components/ColumnManager';
  export { ConfigExporter } from '../src/components/ConfigExporter';
  export { FloatingPanel } from '../src/components/FloatingPanel';
  export { ViewDetector } from '../src/components/ViewDetector';
}
